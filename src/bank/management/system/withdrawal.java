        ...
        setVisible(true);
            ...
            public void actionPerformed(ActionEvent ae){
                if(ae.getSource()==withdrawal){
                    ...
                    Date date=new Date();
                    if(number.equals("")){
                        JOptionPane.showMessageDialog(null, "Please Enter the amount which you want to withdrawal");
                    }else{
                        try{
                        sql c=new sql();
                        String query="insert into bank values ('"+pinnumber+"','"+date+"','+withdrawal+','"+number+"')";
                        c.s.executeUpdate(query);
                        JOptionPane.showMessageDialog(null,"Rupee "+number+" Withdrawal successfully");
                        setVisible(false);
